<?php
    ...
    ["title"        => "WoMozCoffee",
     ...
     "description"  => "Gosta de ensinar? Gosta de aprender? Então venha conhecer o projeto da Mozilla que tem como objetivo ensinar a web para qualquer pessoa.",
		...
		["title" 		=> "Quiz Via Redes Sociais",
		 "description"	=> "Enviaremos uma pergunta em nossas redes sociais os primeiros que responderem receberão um brinde.",
		 "authors"		=> [0, 1, 2, 7],
		 "date"			=> 7,
		 "time"			=> "16:00",
		 "end-time"		=> "17:00",
		...
		["title" 		=> "Minigames na bancada",
		 "description"	=> "Convocaremos pessoas pelas redes sociais para participares de jogos rápidos em nossa bancada valendo swag. Os jogos serão os mesmos que fizemos em nossos games night.",
		 "authors"		=> [0, 1, 2, 7],
		 "date"			=> 7,
		 "time"			=> "16:00",
		 "end-time"		=> "17:00",
		...
		["title" 		=> "Tinder da Fox",
		 "description"	=> "Criar um perfil da Fox no Tinder e dar match no maior número possível de pessoas na Campus. No lugar da conversa lançar um desafio do tipo leve até a bancada do pessoal da Mozilla 5 pessoas com o Firefox instalado no celular e ganhe receba um brinde.",
		 "authors"		=> [0, 1, 2, 7],
		 "date"			=> 7,
		 "time"			=> "16:00",
		 "end-time"		=> "17:00",
